...
public class PartnerPreferencesFragment extends Fragment {
    ...
    String title[]={"My Preferences","Profession Preferences","Family/Location Preferences",
            "Hobby/Interest Preferences","What I am looking for"
    };
    ...
    public PartnerPreferencesFragment(MainActivity mainActivity) {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new MyPreferencesFragment(), "ONE");
        adapter.addFrag(new ProfessionPreferencesFragment(), "TWO");
        adapter.addFrag(new LocationPreferencesFragment(), "THREE");
        adapter.addFrag(new HobbyInfoFragment(), "FOUR");
        adapter.addFrag(new WhatIAmLookingForFragment(), "FIVE");
